...
class Siam extends StatefulWidget {
  const Siam({Key? key}) : super(key: key);

  @override
  State<Siam> createState() => _SiamState();
}

class _SiamState extends State<Siam> {
  final int index = 2;
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage('assets/siam.png'),
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      IconText(
                        ...
                        mainText: "Urban Yard RCA, Bangkok",
                        subText: "1km away",
                        iconColor: word,
                      ...
                      Divider(color: Colors.grey),
                      TextWidget(
                        text: "Description : Asian, Cake, Bread, Sandwich",
                        textType: TextType.medium,
                      ),
                      SizedBox(height: 5),
                      TextWidget(
