...
class TmrLand extends StatefulWidget {
  const TmrLand({Key? key}) : super(key: key);

  @override
  State<TmrLand> createState() => _TmrLandState();
}

class _TmrLandState extends State<TmrLand> {
  final int index = 0;
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage('assets/tmrland.png'),
                  ),
                ),
              ),
              ...
              Transform.translate(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextWidget(
                        text: "Tomorrowland Belgium 2023",
                      ...
                      IconText(
                        ...
                        mainText: "De Schorre Boom, Belgium",
                        subText: "10km away",
                        iconColor: word,
                      ...
                      TextWidget(
                        text:
                            "Description : Europe, Noodles, Burges, Desserts, Halal",
                        textType: TextType.medium,
                      ),
                      SizedBox(height: 5),
                      TextWidget(
                      ...
                      SizedBox(
                        ...
                        child: Padding(
                          padding: EdgeInsets.symmetric(
                              vertical: 2), // Adjust vertical padding here
                          child: TextButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                            ...
                            style: TextButton.styleFrom(
                              ...
                              padding: EdgeInsets.symmetric(
                                  vertical: 5), // Adjust vertical padding here
