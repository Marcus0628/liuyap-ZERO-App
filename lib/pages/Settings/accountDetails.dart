              ...
              Container(
                ...
                child: Column(
                  children: [
                            ...
                            children: [
                              Padding(
                                ...
                                child: Transform.translate(
                                  offset: Offset(0,
                                      5), // Adjust the offset to lower the text
                                  child: Text(
                                    "User Name",
                                    style: TextStyle(
                                      fontSize: 20,
                              ...
                              Padding(
                                ...
                                child: Align(
                                  ...
                                  child: Transform.translate(
                                    offset: Offset(0,
                                        5), // Adjust the offset to lower the icon
                                    child: IconButton(
                                      icon: Icon(
                                        Icons.edit,
                                        size: 26,
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: Transform.translate(
                                      offset: Offset(0,
                                          11), // Adjust the offset to lower the icon
                                      child: Icon(
                                        Icons.edit,
                                        size: 26,
                                      ),
                    ...
                    //SalaryBill
                    // SizedBox(height: 25),
                    if (dropdownValue == 'Low Income Group' ||
                        dropdownValue == 'B40 Group')
                      Container(
                        width: 390,
                        height: 105,
                        decoration: BoxDecoration(
