...
class TopUp2 extends GetView<WalletController> {
  const TopUp2({Key? key}) : super(key: key);
                                                    ...
                                                    () => Row(
                                                        ...
                                                        children: [
                                                          GestureDetector(
                                                            onTap: () => controller
                                                                .setAmount(
                                                                    20), // Change the index to the amount
                                                            child: Container(
                                                              padding:
                                                                  EdgeInsets
                                                                      .all(10),
                                                          ...
                                                          GestureDetector(
                                                            onTap: () => controller
                                                                .setAmount(
                                                                    50), // Change the index to the amount
                                                            child: Container(
                                                              padding:
                                                                  EdgeInsets
                                                                      .all(10),
                                                          ...
                                                          GestureDetector(
                                                            onTap: () => controller
                                                                .setAmount(
                                                                    100), // Change the index to the amount
                                                            child: Container(
                                                              padding:
                                                                  EdgeInsets
                                                                      .all(10),
                                                          ...
                                                          GestureDetector(
                                                            onTap: () => controller
                                                                .setAmount(
                                                                    200), // Change the index to the amount
                                                            child: Container(
                                                              padding:
                                                                  EdgeInsets
                                                                      .all(10),
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      double selectedAmount =
                                                          0.0; // Initialize selectedAmount to zero
                                                      ...
                                                      if (selectedAmount > 0) {
                                                        controller.topUpAmount(
                                                            selectedAmount); // Update balance in WalletController
                                                        ...
                                                        showDialog(
                                                          ...
                                                          builder: (context) =>
                                                            ...
                                                            title: Text(
                                                                'Top-Up Success'),
                                                            content: Text(
                                                                'Your wallet has been successfully topped up with RM${selectedAmount.toStringAsFixed(2)}.\n\nAvailable Balance: RM${Get.find<WalletController>().balance.toStringAsFixed(2)}.'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () {
                                                                  // Close the dialog
